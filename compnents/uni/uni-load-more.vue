<template>
	<view class="uni-load-more" @click="onClick">
		...
		<!-- #endif -->
		<text class="uni-load-more__text" :style="{color: color,fontSize:12}">{{ status === 'more' ? contentText.contentdown : status === 'loading' ? contentText.contentrefresh : contentText.contentnomore }}</text>
	</view>
</template>
